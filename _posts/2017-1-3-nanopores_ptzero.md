...
where $$\gamma=\frac{e^{y_{0}/2}-1}{e^{y_{0}/2}+1}$$, $$y=ze\psi/k_{B}T$$, and $$\kappa^{2}=\frac{2z^{2}e^{2}C_{0}}{\epsilon_{r}\epsilon_{0}k_{B}T}$$. The potential at the surface, $$\psi_{0}$$, is related to the surface charge density via the __Grahame equation__:
