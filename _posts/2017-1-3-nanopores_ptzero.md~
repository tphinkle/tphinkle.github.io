...
where $$\gamma=\frac{e^{y_{0}/2}-1}{e^{y_{0}/2}+1}$$, $$y=ze\psi/k_{B}T$$, and $$\kappa^{2}=\frac{2z^{2}e^{2}C_{0}}{\epsilon_{r}\epsilon_{0}k_{B}T}$$. The electrostatic potential at the surface, $$\psi_{0}$$, is related to the surface charge density via the __Grahame equation__:

$$
\begin{equation}
\tag{Grahame equation}
\sigma=\epsilon_{0}\epsilon_{r}\psi_{0}\kappa^{-1}\left[\frac{2k_{B}T}{ze\psi}\sinh\left(\frac{z^{2}e\psi}{2k_{B}T}\right)\right]
\end{equation}
$$
